  ...
  const categories: Category[] = [
    {
      name: "Personal",
      projects: [
        { title: "Personal Website", skills: ["Next.js"], description: "Central repository for my creative and professional endeavors", link: "https://github.com/robinlovell13/portfolio", startDate: new Date(2025, 1), isActive: true, currentTask: "Improve UX on mobile; fix skills section", status: "In Progress" },
    ...
    },
    {
      name: "Self-study",
      projects: [
        { title: "Build an LLM from Scratch", skills: [], description: "Learn to implement custom LLMs through this book by Sebastian Raschka", startDate: new Date(2024, 11), currentProgress: 32, total: 100, label: "32% complete", status: "In Progress", isActive: true, currentTask: "Chapter 3" },
