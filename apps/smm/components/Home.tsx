...
export default function Home() {
    ...
    return (
        <main className="flex flex-col items-center">
            ...
            <div className="flex grid grid-rows-[auto_1fr_auto] md:grid-cols-[auto_1fr_auto] items-center  md:space-x-6">
            ...
            Resume
                            ...
                            <li className="text-center flex md:items-center justify-start md:justify-center">
                                <a
                                    ...
                                    className="text-foreground hover:text-secondary flex items-center justify-start md:justify-center text-left md:text-center   w-full"
                                >
                ...
                <section id="home" className="md:min-h-[calc(100vh-4rem)]  w-full flex flex-col justify-center items-start text-left ">
